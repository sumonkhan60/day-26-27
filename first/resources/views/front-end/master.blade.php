                                        ...
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    ...
                                                    <li><a href="{{ route('category-product1') }}"> Underwear </a></li>
                                            ...
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{ route('category-product1') }}"><img src="{{ asset('/') }}front-end/images/woo3.jpg" alt=" "/></a>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{ route('category-product1') }}"><img src="{{ asset('/') }}front-end/images/woo4.jpg" alt=" "/></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </ul>
        ...
        <div class="footer-grids">
            ...
            <div class="col-md-3 footer-grid">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('short-codes') }}">Short Codes</a></li>
                    <li><a href="{{ route('contact-us') }}">Mail Us</a></li>
                    <li><a href="{{ route('category-product1') }}">products1</a></li>
                </ul>
            </div>
